...
const employee1 = new Employee('John Doe', 'Monday and Friday');
...
//CODE HERE
const manager1 = new Manager('John Doe', 'Monday and Friday', ['Employee1', 'Employee2']);
manager1.getEmployees(); // Output: John Doe manages Employee1,Employee2

manager1.addEmployee('Employee3');
console.log(manager1.employees); // Output: ['Employee1', 'Employee2', 'Employee3']
