...
function canWeDeliver(zipCode) {
    const validZipCodes = [85205, 90210, 60610, 10001]; // Array of valid zip codes
  
    if (validZipCodes.includes(zipCode)) {
      return "You're in our delivery zone!"; // Zip code is in the array of valid zip codes
    } else {
      return "Sorry, we can't deliver to that address"; // Zip code is not in the array
    }
  }
  
  // Example usage
  console.log(canWeDeliver(84606)); // Output: Sorry, we can't deliver to that address
  console.log(canWeDeliver(85205)); // Output: You're in our delivery zone!
...
function canWeDeliverTwo(zipCode) {
  ...
  // Example usage
  console.log(canWeDeliverTwo(84606)); // Output: Sorry, we can't deliver to that address
  console.log(canWeDeliverTwo(85205)); // Output: You're in our delivery zone!
